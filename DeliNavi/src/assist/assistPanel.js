...
export function mountAssistPanel(){
  ...
  wrap.style.cssText = 'position:fixed;right:12px;bottom:12px;z-index:9999;background:rgba(255,255,255,.92);backdrop-filter:saturate(1.1) blur(6px);padding:8px 10px;border-radius:12px;box-shadow:0 6px 20px rgba(0,0,0,.15);display:flex;gap:10px;align-items:center;font:14px/1.2 system-ui,-apple-system,Segoe UI,Roboto';
  wrap.innerHTML = `
    ...
    <button id="dn-test" style="padding:4px 8px;border:1px solid #ddd;background:#eee;border-radius:8px">テスト</button>
  `;
